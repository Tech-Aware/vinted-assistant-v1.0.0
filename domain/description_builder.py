...
def build_jacket_carhart_description(
    ...
    try:
        ...
        collar_material = _safe_clean(features.get("collar_material"))
        zipper_material = _safe_clean(features.get("zipper_material"))
        ...
        if collar_material:
            details.append(f"Col : {collar_material}.")

        if zipper_material:
            details.append(f"Zip : {zipper_material}.")

        if has_chest_pocket:
            details.append("Poche poitrine zippée visible.")
